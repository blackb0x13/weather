...
# Image
# new = ImageTk.PhotoImage(Image.open('images/Rainy.jpg'))
...
# else:
#     img = ImageTk.PhotoImage(Image.open('images/sun.jpg'))
#     panel = Label(root, image=img)
#     panel.place(x=210, y=200)

# need to set image sizes for project https://www.geeksforgeeks.org/how-to-resize-image-in-python-tkinter/#
...
# Note
note = Label(root, text="All temperatures in degree Fahrenheit",
...
# takes city, state, zip that displays temp, date/time, forecast
